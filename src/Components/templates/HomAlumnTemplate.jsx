...
import { SidebarA, Headers, Scanner, } from "../../index"
import { useState } from "react";


export function HomAlumnTemplate() {
  ...
  return (
    <>
      ...
      <Container className={sidebarOpen ? "sidebarState active" : ""}>
          ...
          />
        <ContentArea>
          {selectedOption === 'Escanear' && <Scanner />} {/* Renderizar Horario si es la opción seleccionada */}
